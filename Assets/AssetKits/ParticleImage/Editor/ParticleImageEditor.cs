...
namespace AssetKits.ParticleImage.Editor
{
    ...
    public class ParticleImageEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _isSetTarget;//내가 추가한거
        ...
        private void OnEnable() 
        {
            ...
            _isSetTarget = serializedObject.FindProperty("_isSetTarget");//내가 추가한거
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_particle.moduleMovementFoldout)
            {
                ...
                EditorGUILayout.PropertyField(_isSetTarget, new GUIContent("SetTarget"), false);
