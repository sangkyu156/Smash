...
namespace AssetKits.ParticleImage
{
    ...
    public sealed class ParticleImage : MaskableGraphic
    {
        ...
        [SerializeField]
        private Module _isSetTarget = new Module(false);
        public bool isSetTarget
        {
            get
            {
                return _isSetTarget.enabled;
            }
            set
            {
                _isSetTarget.enabled = value;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            if (isSetTarget == true)
            {
                attractorTarget = GameObject.FindWithTag("UITarget").transform;
                Debug.Log("UITarget 찾음");
            }
