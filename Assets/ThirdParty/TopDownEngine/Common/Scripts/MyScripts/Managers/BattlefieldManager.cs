...
public class BattlefieldManager : MonoBehaviour, MMEventListener<MMGameEvent>
{
    ...
    void SetRespawnManager()
    {
        ...
        {//0 - 슬라임, 1 - 버섯, 2 - 선인장, 3 - 거미, 4 - 해파리, 5 - 해골, 6 - 박쥐, 7 - 벌, 8 - 킹크랩
            ...
            case Define.Stage.Stage03: objectPooler.Pool[2].Enabled = true; objectPooler.Pool[3].Enabled = true; break;//선인장, 거미
            case Define.Stage.Stage04: objectPooler.Pool[3].Enabled = true; objectPooler.Pool[5].Enabled = true; break;//거미, 해골
            case Define.Stage.Stage05: objectPooler.Pool[5].Enabled = true; objectPooler.Pool[4].Enabled = true; break;//해골, 해파리
            case Define.Stage.Stage06: objectPooler.Pool[6].Enabled = true; objectPooler.Pool[4].Enabled = true; break;//박쥐, 해파리
            case Define.Stage.Stage07: objectPooler.Pool[6].Enabled = true; objectPooler.Pool[7].Enabled = true; break;//박쥐, 벌
            case Define.Stage.Stage08: objectPooler.Pool[7].Enabled = true; objectPooler.Pool[4].Enabled = true; break;//벌, 해파리
            case Define.Stage.Stage09: objectPooler.Pool[3].Enabled = true; objectPooler.Pool[5].Enabled = true; break;//거미, 해골
        }
    }
