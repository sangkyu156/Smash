...
{
    /// <summary>
    /// 재배열 가능한 MMtilemapGeneratorLayers 목록을 표시하는 데 사용되는 클래스
    /// </summary>
    [System.Serializable]
    ...
    /// <summary>
    /// 사용하고 결합할 수 있는 MMtilemapGenerator 레이어의 데이터를 저장하고 편집하는 데 사용되는 클래스입니다.
    /// 고유하고 임의의 그리드를 생성합니다.
    /// </summary>
    [Serializable]
	public class MMTilemapGeneratorLayer
	{
        ...
        /// 이 레이어에서 사용할 수 있는 다양한 융합 모드.
        /// 퓨전 모드는 위에서 아래로 레이어에 적용됩니다(마지막으로 말하는 사람이 승리함).
        /// Normal : 그리드를 생성합니다. 기본 모드입니다.
        /// NormalNoClear : 그리드를 생성하지만 먼저 지우지는 않습니다.
        /// Intersect : 이미 콘텐츠가 있는 대상 그리드에 페인팅할 때 결과 교차점만 유지됩니다.
        /// Combine : 이 그리드의 결과를 기존 대상에 추가합니다.
        /// Subtract : 기존 대상에서 이 그리드의 결과를 제거합니다.
