...
namespace MoreMountains.InventoryEngine
{
    ...
    public class InventoryDisplay : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        ...
        public virtual void InstallationQuickSlotItem(KeyCode key)
        {
            //배틀필드가 아니면 리턴
            ...
            {
                case KeyCode.Alpha1:
                    SlotContainer[0].Installation();
                    break;
                case KeyCode.Alpha2:
                    SlotContainer[1].Installation();
                    break;
                case KeyCode.Alpha3:
                    SlotContainer[2].Installation();
                    break;
                case KeyCode.Alpha4:
                    SlotContainer[3].Installation();
                    break;
                case KeyCode.Alpha5:
                    SlotContainer[4].Installation();
                    break;
                case KeyCode.Alpha6:
                    SlotContainer[5].Installation();
                    break;
            }
        }
        ...
        public virtual void OnMMEvent(MMInventoryEvent inventoryEvent)
        {
            ...
            switch (inventoryEvent.InventoryEventType)
            {
                ...
                case MMInventoryEventType.ContentChanged:
                    ContentHasChanged();
                    RedrawInventoryDisplay();
                    if (TargetInventoryName == "QuickSlots")
