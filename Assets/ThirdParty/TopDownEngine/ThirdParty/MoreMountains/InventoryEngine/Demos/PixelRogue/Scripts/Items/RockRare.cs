...
public class RockRare : InventoryItem
{
    ...
    void ItemSeting()
    {
        ...
        Description = TextUtil.GetText("game:itme:rockrare:long");
    }
    ...
    public override bool Installation(string playerID)
    {
        ...
        craftManual.GetComponent<CraftManual>().go_Prefab = Resources.Load<GameObject>("Prefabs/Battlefield/Obstacles/RockRare");
