...
public class IceRockUnique : InventoryItem
{
    ...
    void ItemSeting()
    {
        ...
        Description = TextUtil.GetText("game:itme:icerockunique:long");
    }
    ...
    public override bool Installation(string playerID)
    {
        ...
        craftManual.GetComponent<CraftManual>().go_Prefab = Resources.Load<GameObject>("Prefabs/Battlefield/Obstacles/IceRockUnique");
