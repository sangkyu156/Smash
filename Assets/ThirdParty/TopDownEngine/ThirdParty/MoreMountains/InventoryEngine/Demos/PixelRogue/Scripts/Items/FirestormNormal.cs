...
public class FirestormNormal : InventoryItem
{
    ...
    {
        grade = Grade.Normal;
        ItemName = TextUtil.GetText("game:itme:firestorm:name");
        ShortDescription = TextUtil.GetText("game:itme:consumable:short");
        Description = TextUtil.GetText("game:itme:firestorm:long");
    }
    ...
    public override bool Installation(string playerID)
    {
        ...
        craftManual.GetComponent<CraftManual>().go_Preview = Resources.Load<GameObject>("Prefabs/Battlefield/Preview/FirestormPreview");
        craftManual.GetComponent<CraftManual>().go_Prefab = Resources.Load<GameObject>("Prefabs/Battlefield/Obstacles/FirestormNormal");
