...
public class ScarecrowBotNormal : InventoryItem
{
    ...
    {
        grade = Grade.Normal;
        ItemName = TextUtil.GetText("game:itme:scarecrowbot:name");
        ShortDescription = TextUtil.GetText("game:itme:rock:short");
        Description = TextUtil.GetText("game:itme:scarecrowbotnomal:long");
    }
    ...
    public override bool Installation(string playerID)
    {
        ...
        craftManual.GetComponent<CraftManual>().go_Preview = Resources.Load<GameObject>("Prefabs/Battlefield/Preview/ScarecrowBotPreview");
        craftManual.GetComponent<CraftManual>().go_Prefab = Resources.Load<GameObject>("Prefabs/Battlefield/Obstacles/ScarecrowBotNormal");
