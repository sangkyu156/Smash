...
{
    /// <summary>
    /// 이 셰이커를 사용하면 변환의 회전을 한 번 또는 영구적으로 이동하여 지정된 기간 동안 지정된 범위 내에서 회전을 흔들 수 있습니다.
    ...
    public class MMRotationShaker : MMShaker
	{
		...
		[Tooltip("회전을 흔들기 위한 변환입니다. 비워 두면 이 구성 요소는 적용된 변환을 대상으로 합니다.")]
		...
		[Tooltip("회전을 흔들기 위한 직사각형 변환입니다. 비워 두면 이 구성 요소는 적용된 변환을 대상으로 합니다.")]
