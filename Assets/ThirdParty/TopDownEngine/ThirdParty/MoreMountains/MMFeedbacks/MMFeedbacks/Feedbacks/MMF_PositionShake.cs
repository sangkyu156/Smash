...
{
    /// <summary>
    /// 이 피드백을 사용하면 PositionShake 이벤트를 내보낼 수 있습니다. 이는 MMPositionShakers(지정된 채널)에 의해 포착됩니다.
    /// 위치 셰이커는 이름에서 알 수 있듯이 선택적 노이즈 및 기타 미세 제어 옵션을 사용하여 방향을 따라 변환의 위치를 ​​셰이크하는 데 사용됩니다.
    /// </summary>
    [AddComponentMenu("")]
	[FeedbackPath("Transform/Position Shake")]
	[FeedbackHelp("이 피드백을 사용하면 PositionShake 이벤트를 내보낼 수 있습니다. 이는 지정된 채널의 MMPositionShaker에 의해 포착됩니다." +
" 위치 셰이커는 이름에서 알 수 있듯이 선택적 노이즈 및 기타 미세 제어 옵션을 사용하여 방향을 따라 변환 위치를 셰이크하는 데 사용됩니다.")]
