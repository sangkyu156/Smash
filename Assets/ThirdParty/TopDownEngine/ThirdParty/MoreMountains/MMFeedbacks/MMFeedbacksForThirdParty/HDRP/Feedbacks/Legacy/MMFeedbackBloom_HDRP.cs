...
{
    /// <summary>
    /// 이 피드백을 통해 시간 경과에 따른 블룸 강도와 임계값을 제어할 수 있습니다. 이를 위해서는 장면에 Bloom이 활성화된 볼륨이 있는 객체와 MMBloomShaker_HDRP 구성 요소가 필요합니다.
    /// </summary>
    [AddComponentMenu("")]
	[FeedbackHelp("이 피드백을 통해 시간 경과에 따른 블룸 강도와 임계값을 제어할 수 있습니다. 장면에 볼륨이 있는 객체가 있어야 합니다. " +
"블룸이 활성화되어 있고 MMBloomShaker_HDRP 구성 요소가 있습니다.")]
